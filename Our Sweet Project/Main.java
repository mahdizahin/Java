...
//##############################################################################################################################################################
			...
			name_store.close();
 			...
 			while(repeat1){
 				...
 				System.out.println("						4.Show All Employee3                               ");
			...
			//##############################################################################################################################################################
					...
					ManagerInfo.close();*/
         			...
         			case 2:
         				System.out.println("----------You Have Selected Staff Management--------------");
         					...
         					System.out.print("Enter your choice : ");												//	Staff
					...
					//#############################################################################################################################################
         				...
         				case 3:
         					...
         					System.out.print("Enter your choice : ");												//	Maid
         					...
         					switch(button90){
         						case 1:
									...
									System.out.print("Enter Salary      :");
									double salary10 = input.nextDouble();
									input.nextLine();
									System.out.print("Enter Nationality :");
...
//###################################################################################################################################################
									...
									{
										System.out.println(EmpID10 + " Maid Has Been Inserted");
									}
									else
									{
										System.out.println(EmpID10 + " Maid Can NOT be Inserted");
									}
...
//#################################################################################################################################
									 ...
									 SingleRmInfo.close();
         								...
         								sr.setRoomNumber(roomNumber);
         									if(hut.addRoom(sr))
										    {
												System.out.println(roomNumber + " Single  Room Has Been Added");
											}
											else
											{
												System.out.println(roomNumber + " Single Room Can NOT be Added");
											}
...
//#########################################################################################################################################################
         								...
         								dr.setRoomNumber(roomNumber);
         									if(hut.addRoom(dr))
										    {
												System.out.println(roomNumber + " Double Room Has Been Added");
											}
											else
											{
												System.out.println(roomNumber + " Double Room Can NOT be Added");
											}
         							}
    	...
    	boolean repeat9 = true;
 			...
 			while(repeat9){
         		...
         		case 1:
         			...
         			while(repeat10){
         		System.out.println("***************       What do you want to do?        ******************");
 				System.out.println("						1.Chack in                            ");
 				System.out.println("						2.Chack out                           ");
 				System.out.println("						3.Go Back                             ");
 				System.out.print("Enter your choice : ");
 				...
 				switch(button11){
 					case 1:
 						System.out.println("OHH WOW You want to chack in <3");
 						System.out.println();

 						System.out.print("What is your Name sir ? ");
 						String Name=input.nextLine();
 						System.out.print("Enter your Phone number sir : ");
 						double phnNumber=input.nextDouble();
 						System.out.print("Enter your Passport Number :");
 						double passportno=input.nextDouble();
 						input.nextLine();
...
//##############################################################################################################################################
                    FileWriter foreignerInfo = new FileWriter(file9_path,true);
 						...
 						if(hut.insertGuest(tv))
							{
								System.out.println(Name + " Sir chack in succesfull");
							}
							else
							{
								System.out.println(Name + "Sir chack in unsuccesfull");
							}
							break;
					case 2:
						System.out.println("----Do you want to Chack out?-----");
						System.out.println();

						System.out.print("Enter your phone number to Chack out : ");
						double phnNumber2 = input.nextDouble();
//######################################################################################################################################################
						...
						{
						    System.out.println("*** Chacked out Sucessfully ***");
						}
						}
						else
						{
							System.out.println("***Unsucessfull Chack out attempet ***");
						}
...
localInfo.close();
 						...
 						if(hut.insertGuest(lg))
							{
								System.out.println(Name + " Sir chack in succesfully");
							}
							else
							{
								System.out.println(Name + "Sir chack in unsuccesfull");
...
localInfo2.close();
						...
						{
						    System.out.println("*** Chacked out Sucessfull ***");
						}
						}
						else
						{
	...
	System.out.println(f1);
 	 ...
 	 /* try{
 	  ...
 	  //	Formatter f = new Formatter(file_path);
		//	System.out.println("Data enty :");
	//	String entry = input.nextLine();

			//f.format("Data entry"+entry);
		//	f.close();
